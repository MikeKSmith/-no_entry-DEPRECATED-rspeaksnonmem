...
devtools::load_code(system.file("R", package="rspeaksnonmem"))
```
...
# user_dir <- file.path(getwd(),"foo")
# dir.create(user_dir)
# file.copy(file.path(system.file("exdata", package="rspeaksnonmem")),
#           file.path(user_dir))
setwd(system.file("exdata", package="rspeaksnonmem"))
```

Rund the model:

```{r}
estimate_NM(modelFile='warfarin_PK_CONC_MKS', modelExtension='.ctl')
```
