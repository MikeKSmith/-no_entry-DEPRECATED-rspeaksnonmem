...
$TABLE ID AMT TIME EVID PRED IPRE CWRES APPEND ONEHEADER NOPRINT FILE=./1004.tab
$TABLE ID TIME CL Q V2 V3 KA ETA1 ETA2 ETA3 APPEND ONEHEADER NOPRINT FILE=./1004par.tab
